...
onlineGSList.forEach(function (li, index) {
  li.addEventListener('mouseover', function () {
    map.panTo(onlineGSMarkers[index].getLatLng(), 14);
...
stoGSList.forEach(function (li, index) {
  li.addEventListener('mouseover', function () {
    map.panTo(stoGSMarkers[index].getLatLng(), 14);
...
// // Create two icons
// var normalIcon = new CustomIcon({
//   iconUrl: 'my-icon.png',
//   iconSize: [38, 95], // Normal size
//   // ... other options ...
// });

// var hoverIcon = new CustomIcon({
//   iconUrl: 'my-icon.png',
//   iconSize: [76, 190], // Larger size
//   // ... other options ...
// });

// // Create a marker with the normal icon
// var marker = L.marker([location.lat, location.lng], {
//   icon: normalIcon,
//   // ... other options ...
// }).addTo(map);

// // Change the icon on mouseover and mouseout
